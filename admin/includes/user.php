...
class User extends Db_object
{
	...
	public function photos() { // ova metoda (funkcija) omogucava ulogovanom korisniku da vidi sammo svoje slike (da bi radilo otkomentarisati linje koda iz photos.php, photo.php, upload.php, glavna funkcija je u user.php zove se photos())
