...
if (empty($_GET['id'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($photo) {
            ...
            $session->message("The photo with ID: {$photo->id} has been updated");
            $photo->save();
                            ...
                            <div class="col-md-4" >
                                <div  class="photo-info-box">
                                    <div class="info-box-header">
                                       <h4>Edit <span id="toggle" class="glyphicon glyphicon-menu-up pull-right"></span></h4>
                                    </div>
                                <div class="inside">
                                  <div class="box-inner">
                                     <p class="text">
                                       <span class="glyphicon glyphicon-calendar"></span> Uploaded on: <?php echo  date('D, d.M, Y @  H:i'); ?>
                                      </p>
                                      <p class="text ">
